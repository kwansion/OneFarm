...
public class tag1 extends AppCompatActivity {
    ...
    private static final String URL_PRODUCTS = "https://www.veonic.com/aigogo.co/e-Farmer/tag1.php/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(tag1.this));
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            rvAdapter adapter = new rvAdapter(tag1.this, productList);
