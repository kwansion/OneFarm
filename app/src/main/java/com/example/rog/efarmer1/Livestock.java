...
public class Livestock extends AppCompatActivity {
    ...
    public void chicken (View v) {
        ...
        getGraphValue("Chicken");
    }
    public void elephant (View v) {

        getGraphValue("Elephant");
    }
    public void rooster (View v) {

        getGraphValue("Rooster");
    }
    ...
    public void getGraphValue(String tag){
         ...
         * */
        String URL_PRODUCTS = "http://veonic.com/aigogo.co/e-Farmer/graph/Livestock.php?id=" + tag;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            graphAdapter adapter = new graphAdapter(Livestock.this, productList);
        ...
        Volley.newRequestQueue(Livestock.this).add(jsonObjectRequest);
    }
}
