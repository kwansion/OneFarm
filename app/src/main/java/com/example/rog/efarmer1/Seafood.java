...
public class Seafood extends AppCompatActivity {
    ...
    public void oyster (View v) {
        getGraphValue("Oyster");
    }
    public void fish (View v) {
        getGraphValue("Fish");
    }
    public void fish_1 (View v) {
        getGraphValue("Squid");
    }
    public void crab (View v) {
        getGraphValue("Crab");
    }
    public void shrimp (View v) {
        getGraphValue("Shrimp");
    }
    ...
    public void getGraphValue(String tag){
         ...
         * */
        String URL_PRODUCTS = "http://veonic.com/aigogo.co/e-Farmer/graph/Seafood.php?id=" + tag;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            graphAdapter adapter = new graphAdapter(Seafood.this, productList);
        ...
        Volley.newRequestQueue(Seafood.this).add(jsonObjectRequest);
    }
}
