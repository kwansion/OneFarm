...
public class Vegetable extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getGraphValue("Carrot");
    }

    public void aubergine (View v) {
       getGraphValue("Aubergine");
    }
    ...
    public void getGraphValue(String tag){
         ...
         * */
        String URL_PRODUCTS = "http://veonic.com/aigogo.co/e-Farmer/graph/Vegetable.php?id=" + tag;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            graphAdapter adapter = new graphAdapter(Vegetable.this, productList);
        ...
        Volley.newRequestQueue(Vegetable.this).add(jsonObjectRequest);
    }
}
